...
def _resnet_encoder(arch, block, layers, pretrained, progress, **kwargs):
...
def resnet18_encoder(pretrained=False, progress=True, **kwargs):
    ...
    """
    return _resnet_encoder('resnet18', BasicBlock, [2, 2, 2, 2], pretrained, progress,
                   **kwargs)
